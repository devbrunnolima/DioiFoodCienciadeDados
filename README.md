![Logo do iFood](https://github.com/devbrunnolima/DioiFoodCienciadeDados/blob/main/logoBootCamp.png)
...
Este repositório serve como meu portfólio de Ciência de Dados, onde compartilho os projetos que realizei ao longo do Bootcamp. Cada projeto é uma demonstração das habilidades e conhecimentos adquiridos durante o programa. Você encontrará análises de dados, implementações de algoritmos de machine learning, visualizações impressionantes e muito mais.

## Como explorar:
Sinta-se à vontade para navegar pelos projetos neste repositório. Cada projeto está organizado em seu próprio diretório, com documentação detalhada e código-fonte acessível. Se você tiver alguma pergunta, feedback ou oportunidades de colaboração, não hesite em entrar em contato.
